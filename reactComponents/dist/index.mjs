...
var ResultDetail = (props) => {
  ...
  return /* @__PURE__ */ React38.createElement(React38.Fragment, null, currentIndex !== index && /* @__PURE__ */ React38.createElement(StyledDetailList, {
    ...
    className: "logo"
  }, /* @__PURE__ */ React38.createElement(Logo, {
    ...
    className: "detail"
  }, "Pair: ", /* @__PURE__ */ React38.createElement("strong", null, firstAndLast(selectedPair.id))), /* @__PURE__ */ React38.createElement("div", {
    className: "count"
  }, /* @__PURE__ */ React38.createElement("div", {
    className: "detail"
...
import React42, { useContext as useContext5 } from "react";
...
var Chip = (props) => {
  ...
  return /* @__PURE__ */ React41.createElement(StyledChip, {
    ...
    htmlFor: `${label}-${name}`
  }, /* @__PURE__ */ React41.createElement(Logo, {
    label,
    grayscaleFilter,
    width: 16,
    height: 16
...
var SearchDescription = (props) => {
  ...
  if (networkCount === 0 && exchangeCount === 0) {
    ...
    if (type === "network")
      ...
      }, "Searching\xA0", /* @__PURE__ */ React44.createElement(StyledCount, null, networkCount, " network(s)"), "\xA0within\xA0", /* @__PURE__ */ React44.createElement(StyledCount, null, exchangeCount, " exchange(s)"));
    else
      desc = /* @__PURE__ */ React44.createElement("div", {
        style: { display: "flex", justifyContent: "right" }
      }, "Searching\xA0", /* @__PURE__ */ React44.createElement(StyledCount, null, exchangeCount, " exchange(s)"), "\xA0within\xA0", /* @__PURE__ */ React44.createElement(StyledCount, null, networkCount, " network(s)"));
  }
...
render(/* @__PURE__ */ React47.createElement(SearchBar, null), rootElement);
export {
